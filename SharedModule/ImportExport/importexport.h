...
class ImportExport
{
    ...
    ImportExport(){}
public:
    static AsyncResult WriteSecuritySum(const ImportExportSourcePtr& source, const AsyncResult& res);
    static bool CheckSecuritySum(const ImportExportSourcePtr& source);
    ...
    {
        return StandardImportExportDevice(source, QIODevice::ReadWrite | QIODevice::Truncate, [=]() -> qint8{
...
inline ImportExportDelegate<T> ImportExportDelegate<T>::CreateSerializerXmlStandardDelegate(const SerializerXmlVersion* version, const std::function<qint8 (const ImportExportSourcePtr& source, SerializerXmlReadBuffer&, const T& obj)>& importer, const std::function<qint8 (const ImportExportSourcePtr& source, SerializerXmlWriteBuffer&, const T& obj)>& exporter)
{
    ...
    if(exporter != nullptr) {
        result.ExportDelegate = [=](const ImportExportSourcePtr& source, const T& obj) -> AsyncResult {
            return ImportExport::WriteSecuritySum(source, ImportExport::StandardSerializerXmlExportDevice(source, version, [=](const ImportExportSourcePtr& source, SerializerXmlWriteBuffer& buffer)-> qint8 {
...
inline ImportExportDelegate<T> ImportExportDelegate<T>::CreateSerializerStandardDelegate(const SerializerVersion* version, const std::function<qint8 (const ImportExportSourcePtr& source, SerializerReadBuffer&, const T& obj)>& importer, const std::function<qint8 (const ImportExportSourcePtr& source, SerializerWriteBuffer&, const T& obj)>& exporter)
{
    ...
    if(exporter != nullptr) {
        result.ExportDelegate = [=](const ImportExportSourcePtr& source, const T& obj) -> AsyncResult {
            return ImportExport::WriteSecuritySum(source, ImportExport::StandardSerializerExportDevice(source, version, [=](const ImportExportSourcePtr& source, SerializerWriteBuffer& buffer)-> qint8 {
                return exporter(source, buffer, obj);
            }));
        };
    }
...
inline ImportExportDelegate<T> ImportExportDelegate<T>::CreateSerializerJsonStandardDelegate(const SerializerXmlVersion* version, const std::function<qint8 (const ImportExportSourcePtr& source, SerializerJsonReadBuffer&, const T& obj)>& importer, const std::function<qint8 (const ImportExportSourcePtr& source, SerializerJsonWriteBuffer&, const T& obj)>& exporter)
{
    ...
    if(exporter != nullptr) {
        result.ExportDelegate = [=](const ImportExportSourcePtr& source, const T& obj) -> AsyncResult {
            return ImportExport::WriteSecuritySum(source, ImportExport::StandardSerializerJsonExportDevice(source, version, [=](const ImportExportSourcePtr& source, SerializerJsonWriteBuffer& buffer)-> qint8 {
                return exporter(source, buffer, obj);
            }));
        };
    }
