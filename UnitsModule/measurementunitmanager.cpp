...
void MeasurementManager::Initialize()
{
    ...
    AddMeasurement(MeasurementSmallForce::Value)
            .AddUnit(&ForceUnits::Newton)
            .AddUnit(&ForceUnits::Kilonewton)
            .AddUnit(&ForceUnits::PoundsForce)
            .AddUnit(&ForceUnits::KiloGrammForce)
    ...
    AddMeasurement(MeasurementNormalizedForce::Value)
            .AddUnit(&ForceUnits::Newton)
            .AddUnit(&ForceUnits::Kilonewton)
            .AddUnit(&ForceUnits::PoundsForce)
            .AddUnit(&ForceUnits::KiloGrammForce)
    ...
    AddMeasurement(MeasurementSmallTime::Value)
            .AddUnit(&TimeUnits::MSeconds)
            .AddUnit(&TimeUnits::Seconds)
            .AddUnit(&TimeUnits::Minutes)
            .AddUnit(&TimeUnits::Hours);

//    AddMeasurement(MeasurementVolumePerLength::Value)
...
//            .AddUnit(&VolumePerLengthUnits::CubicInchPerFoot);
    ...
    AddMeasurement(MeasurementCasingWearVolume::Value)
            .AddUnit(&VolumePerLengthUnits::CubicMeterPerMeter)
            .AddUnit(&VolumePerLengthUnits::CubicMilimeterPerMeter)
            .AddUnit(&VolumePerLengthUnits::BarrelPerFoot)
            .AddUnit(&VolumePerLengthUnits::CubicInchPerFoot);
    ...
    AddMeasurement(MeasurementStrokeFrequency::Value)
            .AddUnit(&FrequencyUnits::StrokePerSecond)
            .AddUnit(&FrequencyUnits::StrokePerMinute);
    ...
    AddSystem(UNIT_SYSTEM_API_USFT, true)
            ...
            .AddParameter(MeasurementMudWeight::NAME,         {DensityUnits::PoundsPerGallon.Id,            2, 0.1})
            .AddParameter(MeasurementDensity::NAME,   {DensityUnits::PoundsPerCubicFeet.Id,          2, 0.1})
            .AddParameter(MeasurementSolidDensity::NAME,      {DensityUnits::SpecificGravity.Id,          2, 0.1})
            ...
            .AddParameter(MeasurementNormalizedForce::NAME,       {ForceUnits::PoundsForce.Id,               2})
            .AddParameter(MeasurementSmallForce::NAME,       {ForceUnits::PoundsForce.Id,               2})
            .AddParameter(MeasurementFrequency::NAME,        {FrequencyUnits::RevolutionPerMinute.Id,       1})
            .AddParameter(MeasurementStrokeFrequency::NAME,  {FrequencyUnits::StrokePerMinute.Id,       1})
            ...
            .AddParameter(MeasurementCasingWearVolume::NAME, {VolumePerLengthUnits::CubicInchPerFoot.Id,    6})
            ...
            .AddParameter(MeasurementSmallTime::NAME,        {TimeUnits::Minutes.Id,                        2})
    ...
    AddSystem(UNIT_SYSTEM_API, true)
            ...
            .AddParameter(MeasurementTime::NAME,              {TimeUnits::Hours.Id,                          2})
            .AddParameter(MeasurementSSTime::NAME,           {TimeUnits::Seconds.Id,                        2})
            .AddParameter(MeasurementSmallTime::NAME,        {TimeUnits::Minutes.Id,                        3})
            .AddParameter(MeasurementTorque::NAME,            {TorqueUnits::KilopoundForceFeet.Id,           1})
            .AddParameter(MeasurementViscosity::NAME,         {ViscosityUnits::Centipoise.Id,                2})
            .AddParameter(MeasurementWeightPerLength::NAME, {WeightPerLengthUnits::PoundPerFoot.Id,        2})
            .AddParameter(MeasurementYieldPoint::NAME,       {PressureUnits::PoundsPer100SquareFeet.Id,        2})
    ...
    AddSystem(UNIT_SYSTEM_SI, true)
            ...
            .AddParameter(MeasurementMudWeight::NAME,         {DensityUnits::KilogramsPerCubicMeters.Id,    1, 10})
            .AddParameter(MeasurementDensity::NAME,   {DensityUnits::KilogramsPerCubicMeters.Id,    1, 10})
            .AddParameter(MeasurementSolidDensity::NAME,      {DensityUnits::KilogramsPerCubicMeters.Id,    1, 10})
            ...
            .AddParameter(MeasurementNormalizedForce::NAME,       {ForceUnits::Newton.Id,               2})
            .AddParameter(MeasurementSmallForce::NAME,       {ForceUnits::Newton.Id,                    2})
            .AddParameter(MeasurementFrequency::NAME,        {FrequencyUnits::RevolutionPerSecond.Id,       1})
            .AddParameter(MeasurementStrokeFrequency::NAME,  {FrequencyUnits::StrokePerSecond.Id,           3})
            .AddParameter(MeasurementFunnelViscosity::NAME,  {FunnelViscosityUnits::SecondsForQuart.Id,     1})
            .AddParameter(MeasurementLinearCapacity::NAME,   {VolumePerLengthUnits::CubicMeterPerMeter.Id,  2})
            .AddParameter(MeasurementCasingWearVolume::NAME, {VolumePerLengthUnits::CubicMilimeterPerMeter.Id,  6})
            ...
            .AddParameter(MeasurementTime::NAME,              {TimeUnits::Hours.Id,                          2})
            .AddParameter(MeasurementSSTime::NAME,           {TimeUnits::Seconds.Id,                        2})
            .AddParameter(MeasurementSmallTime::NAME,        {TimeUnits::Seconds.Id,                        2})
            ...
            .AddParameter(MeasurementTemperaturePerDistance::NAME, {TemperaturePerDistanceUnits::CelsiusPer100Meter.Id,  5})
