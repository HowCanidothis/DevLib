...
namespace PressureUnits
{
    ...
    static const MeasurementUnit PoundsPerSquareFeet         ("Pounds Per 100 Square Feet"    , []{return QObject::tr("pounds-force/100 sq.feet");     }, []{ return QObject::tr("lbf/100ft2");}, 0.47880172);
}
