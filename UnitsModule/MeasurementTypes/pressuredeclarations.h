...
namespace PressureUnits
{
    ...
    static const MeasurementUnit KilogramPerSquareMeter      ("Kilogram Per Square Meter"     , []{return QObject::tr("kilogram-forces/sq.meter");     }, []{ return QObject::tr("kgf/m2");    }, 98066.5      );
