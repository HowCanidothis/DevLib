...
IMPLEMENT_MEASUREMENT(MeasurementDistance)
IMPLEMENT_MEASUREMENT(MeasurementDiameter)
IMPLEMENT_MEASUREMENT(MeasurementJetDiameter)
IMPLEMENT_MEASUREMENT(MeasurementCutterDiameter)
