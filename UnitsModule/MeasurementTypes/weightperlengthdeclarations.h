...
namespace WeightPerLengthUnits
{
    ...
    static const MeasurementUnit KilogramPerCantimeter("KilogramPerCantimeter", []{return QObject::tr("kilogram per cantimeter");}, []{ return QObject::tr("kg/cm"); }, 1.0);
    static const MeasurementUnit PoundPerFoot("PoundPerFoot", []{return QObject::tr("pound per foot");}, []{ return QObject::tr("lb/ft"); }, 1.0);
    static const MeasurementUnit PoundPerInch("PoundPerInch", []{return QObject::tr("pound per inch");}, []{ return QObject::tr("lb/in"); }, 1.0);
};
...
#define ATTACH_WEIGHT_PER_LENGTH_MEASUREMENT(delegate, min, max, step) \
    ATTACH_MEASUREMENT(MEASUREMENT_WEIGHT_PER_LENGTH, delegate, min, max, step)
